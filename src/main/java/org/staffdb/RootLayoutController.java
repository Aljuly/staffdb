...
public class RootLayoutController {
    ...
    private void handleNew() {
        ...
        mainApp.setStaffDataFilePath(null);
    }
    ...
    private void handleOpen() {
        ...
        if (file != null) {
            mainApp.loadStaffDataFromFile(file);
        }
    }
    ...
    private void handleSave() {
        File staffFile = mainApp.getStaffDataFilePath();
        if (staffFile != null) {
            mainApp.saveStaffDataToFile(staffFile);
        } else {
            handleSaveAs();
        }
    }
    ...
    private void handleSaveAs() {
        ...
        if (file != null) {
            ...
            mainApp.saveStaffDataToFile(file);
        }
    }
    ...
    private void handleAbout() {
        ...
        alert.setTitle("StaffApp");
        alert.setHeaderText("About");
        alert.setContentText("Author: Aljuly");
